...
public class AdminService {
    ...
    private static AdminService userDao;
    private static PasswordCryptographyProvider cryptographyProvider;
    @Autowired
    private ImageDao imageDao;

    public UserEntity getUser(final String userUuid) throws UserNotSignedInException{
        UserEntity userEntity = userDao.getUser(userUuid);

        if(userEntity == null){

            throw new UserNotSignedInException("USR-001","User not found");
        }
...
//    public String getImage(final String imageUuid, final String authorization) throws ImageNotFoundException, UnauthorizedException, UserNotSignedInException {
//
...
//    public UserAuthTokenEntity updateImage(final ImageEntity imageEntity, final String authorization) throws ImageNotFoundException, UnauthorizedException, UserNotSignedInException {
//        UserAuthTokenEntity userAuthTokenEntity = imageDao.getUserAuthToken(authorization);
//
//        String role = userAuthTokenEntity.getUser().getRole();
